...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Etiqueta Adicionar</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Etiqueta Adicionar</li>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Adicionar Etiqueta</h4>
                </div>
                <div class="card-body">
                    @if (count($errors) > 0)
                    ...
                    @endif        
                        <form action="{{action('Backend\TagController@store')}}" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />                
                            <div class="form-body">
                                <h3 class="box-title">Informações da Etiqueta</h3>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="switch">
                                            <label>Ativar
                                                <input type="checkbox" name="active" value="1" checked><span class="lever"></span>Desativar</label>
                                        </div>
                                    </div>
                                </div>   
                            </div>
