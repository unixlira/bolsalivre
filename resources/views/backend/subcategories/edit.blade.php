...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Subcategoria Editar</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Subcategoria Editar</li>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Editar Subcategoria</h4>
                </div>
                <div class="card-body">
                    @if (count($errors) > 0)
                    ...
                    @endif        
                        <form action="{{action('Backend\SubcategoryController@update', $subcategory->id)}}" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />                
                            <div class="form-body">
                                <h3 class="box-title">Informações Subcategoria</h3>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="name" value="{{ $subcategory->name }}" placeholder="Nome" required>
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="internal_subcategory" value="{{ $subcategory->internal_subcategory }}" placeholder="" required>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <input type="file" name="image" id="input-file-now" class="dropify"  data-show-remove="false"
                                            <?php if($subcategory->image){ ?> data-default-file="{{ asset("storage/subcategories/$subcategory->image") }}" <?php } ?>
                                            />
                                        <input type="hidden" name="pathImage" value="subcategories/<?php echo $subcategory->image ?>" />
