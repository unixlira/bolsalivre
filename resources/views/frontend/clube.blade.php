		...
		<div class="row">
			<div class="col-xs-12 col-sm-6 col-md-5">
				...
				<div class="career">
					...
					<p>Buscamos profissionais comprometidos com a satisfação de nossos clientes e com o crescimento da empresa, que
						gostam de aprender e queiram evoluir conosco. Se você tem esse perfil, envie seu currículo para
				...
				<div class="accordion" id="accordionFAQ">
					<div class="card">
						...
						<div id="collapse1" class="collapse" aria-labelledby="heading1" data-parent="#accordionFAQ">
							<div class="card-body">
								<p>O BolsaLivre.com é um site que oferece para toda e qualquer pessoa, bolsas de estudos parciais,
									disponibilizadas por instituições particulares parceiras.</p>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordionFAQ">
							<div class="card-body">
								<p>Sim. As bolsas são disponibilizadas para todas pessoas, que querem estudar pagando menos, que são antenadas
									em oportunidades e descontos, com mensalidades que cabem no bolso.</p>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordionFAQ">
							<div class="card-body">
								<p>Após escolher a sua bolsa, clique em QUERO ESTA BOLSA, inscreva-se etapa seguinte - dados que vão constar no
									seu Comprovante de Pré-Matricula para conferência na instituição de ensino, clique em FINALIZAR COMPRA, efetue
									o pagamento pelo PagSeguro - através de boleto ou cartão de crédito - receba a confirmação por e-mail e a
									liberação do Comprovante de Pré Matrícula por e-mail e na sua conta no site.</p>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordionFAQ">
							<div class="card-body">
								<p>Logo que o Comprovante de Pré-Matricula estiver disponível. A liberação do documento acontece após a
									compensação pagamento da taxa de inscrição, que é realizada aqui mesmo no site, via cartão de crédito ou
									boleto bancário. Ao contrario de outros projetos, o pagamento realizado é de uma taxa única, referente e
									equivalente a primeira mensalidade da instituição já com a bolsa, e garante a bolsa por toda etapa de formação
									ou por todo curso escolhido.</p>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordionFAQ">
							<div class="card-body">
								<p>Sim! Contribuímos com a educação no Rio de Janeiro desde 2011 em projetos similares através de sites, em
									projeto social de alfabetização de jovens que não tinham mais perspectivas.</p>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapse6" class="collapse" aria-labelledby="heading6" data-parent="#accordionFAQ">
							<div class="card-body">
								<p>Sim! Naturalmente podem ocorrer reajustes, mas o percentual liberado no comprovante de pré-matricula é
									valido até a conclusão do curso ou etapa de formação.</p>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="collapse7" class="collapse" aria-labelledby="heading7" data-parent="#accordionFAQ">
							<div class="card-body">
								<p>Vamos conferir o ocorrido, e prestar esclarecimentos imediatamente. Se a matrícula não puder ser efetivada
									vale a nossa política “bolsa garantida ou seu dinheiro de volta”, realizamos o estorno do valor integral pago
									ao site Bolsa Livre.</p>
							</div>
						</div>
					</div>
				</div>
